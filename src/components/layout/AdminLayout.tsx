...
export const AdminLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-stone-50">
      ...
      {/* Sidebar */}
      <div className={cn(
        "fixed inset-y-0 left-0 z-50 w-64 bg-stone-900 transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:flex lg:flex-col",
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      )}>
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center justify-between h-16 px-6 border-b border-stone-800 shrink-0">
          ...
          <div className="border-t border-stone-800 p-4 shrink-0">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-stone-400 text-xs">Administrator</div>
              </div>
            </div>
            <Button
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex flex-1 items-center">
              <h1 className="text-lg font-semibold text-stone-900">
                {navItems.find(item => isActive(item.href))?.title || 'Admin Dashboard'}
              </h1>
            </div>
          </div>
        </div>
